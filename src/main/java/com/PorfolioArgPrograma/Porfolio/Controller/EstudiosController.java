...
public class EstudiosController {
    ...
    public ResponseEntity<?> crear(@Valid @RequestBody EstudiosDto estudiosDto) {
        ...
        if (!StringUtils.hasText(estudiosDto.getInstitucionEstudio()))
            return new ResponseEntity<>(new Mensaje("El nombre de la institución es obligatorio"),
        ...
        try {
            ...
            return new ResponseEntity<>(new Mensaje("Formato de fecha inválido. Use yyyy-MM-dd"),
                    HttpStatus.BAD_REQUEST);
        }
    }
